...
import postRequest from "../commonComponents/Button/POST/POSTrequest";
                        ...
                        <section className='modal_body__input-field'>
                            <section className="modal_body__text">
                                ...
                                <section className="modal_form">
                                    <input type='email' className="modal_input general_text" placeholder="E-mail" defaultValue='' id='subscribe-value'/>
                            ...
                            <section className='modal_body__subtext'><p className='general_subtext_light text-center'>You always can undo that in any of your received emails </p></section>
                        </section>
                    </section>
