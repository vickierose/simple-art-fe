            ...
            <section className='modal_bg'></section>
                <section className='modal_main'>
                    <section className='modal_body'>
                        <section className='modal_body__close'><img src={Close_button} onClick={() => setVisible(false)}/></section>
                        <section className='modal_body__input-field'>
                            <section className="modal_body__text">
                                ...
                                <form className="modal_form">
                                    <input type='email' className="modal_input general_text" placeholder="E-mail" />
